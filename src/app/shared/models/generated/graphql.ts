...
export type UpdateQrjPublicationMutationMutationVariables = {
  input?: Maybe<QrjPublicationUpdateInput>;
};


export type UpdateQrjPublicationMutationMutation = (
  { __typename?: 'Mutation' }
  & { updateQrjPublication?: Maybe<(
    { __typename?: 'QrjPublication' }
    & Pick<QrjPublication, 'id' | 'index' | 'edited' | 'year' | 'number' | 'pages' | 'inputDate'>
    & { qrjJournal?: Maybe<(
      { __typename?: 'QrjJournal' }
      & Pick<QrjJournal, 'code'>
      & { translation: Array<(
        { __typename?: 'QrjJournalTranslation' }
        & Pick<QrjJournalTranslation, 'name'>
      )> }
    )>, oecd?: Maybe<(
      { __typename?: 'Oecd' }
      & Pick<Oecd, 'code'>
...
export type CreateQrjPublicationMutationMutationVariables = {
  input?: Maybe<QrjPublicationCreateInput>;
};


export type CreateQrjPublicationMutationMutation = (
  { __typename?: 'Mutation' }
...
export type DeleteQrjPublicationMutationMutationVariables = {
  id?: Maybe<Scalars['ID']>;
};


export type DeleteQrjPublicationMutationMutation = (
  { __typename?: 'Mutation' }
...
export const UpdateQrjPublicationMutationDocument = gql`
  ...
  export class UpdateQrjPublicationMutationGQL extends Apollo.Mutation<UpdateQrjPublicationMutationMutation, UpdateQrjPublicationMutationMutationVariables> {
    document = UpdateQrjPublicationMutationDocument;
    
  }
export const CreateQrjPublicationMutationDocument = gql`
  ...
  export class CreateQrjPublicationMutationGQL extends Apollo.Mutation<CreateQrjPublicationMutationMutation, CreateQrjPublicationMutationMutationVariables> {
    document = CreateQrjPublicationMutationDocument;
    
  }
export const DeleteQrjPublicationMutationDocument = gql`
  ...
  export class DeleteQrjPublicationMutationGQL extends Apollo.Mutation<DeleteQrjPublicationMutationMutation, DeleteQrjPublicationMutationMutationVariables> {
    document = DeleteQrjPublicationMutationDocument;
